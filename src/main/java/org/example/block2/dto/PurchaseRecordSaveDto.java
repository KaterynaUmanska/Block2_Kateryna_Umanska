...
public class PurchaseRecordSaveDto {
    ...
    @Schema(description = "Material ID associated with this record", example = "1", required = true)
    ...
    @Schema(description = "Required material quantity", example = "15.5", required = true)
